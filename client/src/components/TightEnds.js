    ...
    return (
      <div>
        ...
        <div className="positionpic">
          <img className="positionimage" src={"https://static01.nyt.com/images/2015/01/21/sports/21patriots/21patriots-master1050.jpg"} style={{height: '460px', width: '690px', margin: 'auto'}}/><br></br><br></br>
        </div>
